...
import Navbar from './Navbar/Navbar'; //importo el componente Narbar y lo añado en el div
      ...
      <div>
        <h4>Servicios</h4>
          ...
          <ul className="columns">
            ...
            <li className="box"><img src = {img5} id="iconos" alt="Logo hucha" width = "150px" height ="150px"/><p>Olvídate de la dificultad de la ingeniería fiscal</p><p><b>Dedícate a tu negocio y nosotros a tus impuestos</b></p></li>
            <li className="box"><img src = {img6} id="iconos" alt="Logo pieza puzzle" width = "150px" height ="150px"/><p>Formamos parte de tu equipo como uno más</p><p><b>Juntos definimos la planificación estratégica</b></p></li>
          </ul>
          <div className="aboutus">
          <p>Somos una consultoría financiera con más de 20 años de experiencia en el control de gestión de las empresas</p>
